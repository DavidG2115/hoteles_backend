    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rol', models.CharField(choices=[('administrador', 'Administrador'), ('gerente', 'Gerente'), ('camarista', 'Camarista'), ('mantenimiento', 'Mantenimiento'), ('cliente', 'Cliente')], default='cliente', max_length=20)),
