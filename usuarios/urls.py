...
urlpatterns = [
    ...
    path('asignar-empleado/', AsignarEmpleadoView.as_view(), name='asignar-empleado'),
    path('desasignar-empleado/', DesasignarEmpleadoView.as_view(), name='desasignar-empleado'),
]
